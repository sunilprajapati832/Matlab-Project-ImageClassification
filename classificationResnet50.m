...
categories = {'accordion','airplanes','anchor','ant','BACKGROUND_Google','barrel','bass','beaver',...
    'binocular','bonsai','brain','brontosaurus','buddha','butterfly','camera','cannon','car_side',...
    'ceiling_fan','cellphone','chair','chandelier','cougar_body','cougar_face','crab','crayfish',...
    'crocodile','crocodile_head','cup','dalmatian','dollar_bill','dolphin','dragonfly','electric_guitar',...
    'elephant','emu','euphonium','ewer','Faces','Faces_easy','ferry','flamingo','flamingo_head','garfield',...
